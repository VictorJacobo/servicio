...
--
-- Host: 127.0.0.1    Database: laboratorio_hardware
-- ------------------------------------------------------
...
CREATE TABLE `prestamos` (
  ...
  PRIMARY KEY (`Matricula_A`,`Matricula_Admin`),
  KEY `IdEquipo` (`IdEquipo`),
  CONSTRAINT `prestamos_ibfk_1` FOREIGN KEY (`IdEquipo`) REFERENCES `equipo` (`idEquipo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-10-10 14:44:56
